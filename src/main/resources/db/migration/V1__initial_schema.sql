...
-- Enum columns: INTEGER (Hibernate default for @Convert) with integer keys from ConvertableEnum (see domain/converter)
...
--   OrganizationPlan:        STARTER=1, PROFESSIONAL=2, ENTERPRISE=3
...
INSERT INTO organizations (id, name, slug, display_name, domain, description, status, plan, country, created_at, updated_at)
VALUES ('aaaaaaaa-0000-0000-0000-000000000001', 'Acme Corp', 'acme-corp', 'Acme Corporation', 'acmecorp.com',
        'Primary enterprise tenant for Acme Corp', 1, 3, 'US', now(), now()),
       ('aaaaaaaa-0000-0000-0000-000000000002', 'Beta LLC', 'beta-llc', 'Beta LLC', 'betallc.io',
        'Secondary tenant for Beta LLC', 1, 1, 'US', now(), now()) ON CONFLICT DO NOTHING;
...
VALUES ('bbbbbbbb-0000-0000-0000-000000000001',
       ...
       ('bbbbbbbb-0000-0000-0000-000000000002',
        ...
        2, NULL, FALSE, TRUE, 0, 1, now(), now()) ON CONFLICT DO NOTHING;
...
VALUES ('cccccccc-0000-0000-0000-000000000001',
       ...
       ('cccccccc-0000-0000-0000-000000000003',
        ...
        4, 2, now(), now()) ON CONFLICT DO NOTHING;
